%%
%% Agentic AI Paper — Artificial Intelligence Review Submission
%% Paper #1 in the AI Systems Landscape 2026 series
%%
%% Artificial Intelligence Review (Springer) formatting:
%%   - Uses Springer Nature sn-jnl document class
...
%%
%% Previous submission: Nature Machine Intelligence (NATMACHINTELL-A26041846)
%%   - Desk-rejected 7 April 2026 (scope mismatch, not quality)
%%
%% Preprint: engrXiv DOI 10.31224/6738 (March 2026)
%%

%% ================================================================
%% DOCUMENT CLASS — Springer Nature Journal
%% ================================================================
%% Options:
%%   sn-mathphys-num  = Math/Physics numbered refs
%%   sn-mathphys-ay   = Math/Physics author-year refs
%%   sn-basic         = Basic Springer (author-year)
%%   sn-vancouver     = Vancouver numbered refs
%%
%% AIR uses author-year citations:
...
\title[PPAS: An Architectural Framework for Agentic AI]{Perceive, Plan, Act, Self-Correct: An Architectural Framework for Goal-Directed Agentic AI Systems}

\author*[1]{\fnm{Hameem M.} \sur{Mahdi}}\email{mahdi.hameem@mayo.edu}

\affil*[1]{\orgname{Mayo Clinic}, \orgaddress{\city{Rochester}, \state{MN}, \postcode{55905}, \country{USA}}}
...
\keywords{Agentic AI \and Large language models \and AI architectures \and Multi-agent systems \and Agent frameworks \and Model Context Protocol \and Human-in-the-loop}
...
This manuscript was previously submitted to \emph{Nature Machine Intelligence} (NATMACHINTELL-A26041846, 3 April 2026) and desk-rejected on 7 April 2026 without external peer review. The editor confirmed the rejection was due to scope/fit rather than quality concerns.
