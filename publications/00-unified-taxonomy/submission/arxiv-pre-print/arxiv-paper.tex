%%
%% arxiv-paper.tex — arXiv preprint version
%% Original: ACM TIST Formatted Paper
%% Converted to standard LaTeX article class for arXiv submission
%%
...
\usepackage{lmodern}           % Latin Modern fonts (available on arXiv)
...
%% ── TikZ (same libraries as original) ──
\usepackage{tikz}
...
%% ── natbib for citation commands (compatible with bibtex) ──
\usepackage[numbers,sort&compress]{natbib}

\newcommand{\orcidicon}[1]{\href{https://orcid.org/#1}{\mbox{\textcolor[RGB]{166,206,57}{\textbullet}}}}
...
\author[1]{Hameem Mahdi~\orcidicon{0009-0007-0005-3080}}
\affil[1]{Mayo Clinic, Rochester, MN, USA \\\texttt{mahdi.hameem@mayo.edu}}
...
%%
%% Keywords (arXiv style — placed after abstract)
