...
%%
%% For submission and review of your manuscript please use:
%%   \documentclass[acmsmall,screen,review]{acmart}
%% When submitting camera ready or to TAPS, change to:
...
%% Rights management information.  These commands have SAMPLE
%% values in them; ACM will provide the correct values after acceptance.
...
\titlenote{Preprint available on aiXiv (Paper ID: \texttt{aixiv.260413.000007}, \url{https://aixiv.science/}).}
...
\bibliography{acm-csur-references}
