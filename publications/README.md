...
## Preprint Servers Used (12 unique across 20 papers)

| Server          | Paper(s)           | Operator                            | URL                                 |
| --------------- | ------------------ | ----------------------------------- | ----------------------------------- |
...
| EarthArXiv      | #15                | Center for Open Science (OSF)       | https://eartharxiv.org/             |
| SocArXiv        | #16                | Center for Open Science (OSF)       | https://osf.io/preprints/socarxiv/  |
| MetaArXiv       | #19                | Center for Open Science (OSF)       | https://osf.io/preprints/metaarxiv/ |
...
| JMLR                             | #04   | [JMLR Inc.](https://jmlr.org/)                         | https://jmlr.org/                                                      | [Email-based](https://jmlr.org/author-info.html)                     | ~6.0  | Yes (free)        |
...
| INFORMS Journal on Computing     | #12   | [INFORMS](https://www.informs.org/)                    | https://pubsonline.informs.org/journal/ijoc                            | [ScholarOne](https://mc.manuscriptcentral.com/ijoc)                  | ~2.1  | Hybrid            |
| IEEE TRO                         | #13   | [IEEE](https://www.ieee.org/)                          | https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=8860          | [PaperCept](https://ras.papercept.net/)                              | ~6.8  | Hybrid            |
| JAMIA                            | #14   | [AMIA / Oxford Univ. Press](https://academic.oup.com/) | https://academic.oup.com/jamia                                         | [ScholarOne](https://mc.manuscriptcentral.com/jamia)                 | ~7.4  | Hybrid            |
| PLOS ONE                         | #15   | [PLOS](https://plos.org/)                              | https://journals.plos.org/plosone/                                     | [Editorial Manager](https://www.editorialmanager.com/pone/)          | ~3.7  | Yes (APC ~$1,931) |
| ACM TOIS                         | #16   | [ACM](https://www.acm.org/)                            | https://dl.acm.org/journal/tois                                        | [ScholarOne](https://mc.manuscriptcentral.com/tois)                  | ~5.6  | Optional          |
| Machine Learning                 | #17   | [Springer Nature](https://www.springernature.com/)     | https://link.springer.com/journal/10994                                | [Editorial Manager](https://www.editorialmanager.com/mach/)          | ~4.9  | Hybrid            |
| Nature Computational Science     | #18   | [Springer Nature](https://www.springernature.com/)     | https://www.nature.com/natcomputsci/                                   | [MTS](https://mts-natcomputsci.nature.com/)                          | ~12.0 | Hybrid            |
| JAIR                             | #19   | [AI Access Foundation](https://www.jair.org/)          | https://www.jair.org/                                                  | [JAIR Portal](https://www.jair.org/index.php/jair/about/submissions) | ~5.0  | Yes (free)        |
...
│       └── artificial-intelligence-review-peer-review/ ← Artificial Intelligence Review
├── 02-analytical-ai/
│   └── submission/
...
├── 03-autonomous-ai/
│   └── submission/
│       ├── arxiv-pre-print/           ← arXiv preprint (cs.RO)
...
│   └── submission/
│       ├── research-square-pre-print/ ← Research Square preprint (Springer Nature)
│       └── npj-digital-medicine-peer-review/ ← npj Digital Medicine
├── 07-evolutionary-genetic-ai/
│   └── submission/
│       ├── techrxiv-pre-print/        ← TechRxiv preprint (IEEE)
...
- **Publisher-aligned preprints:** When the peer-review publisher operates a preprint server (Elsevier → SSRN, IEEE → TechRxiv, Springer Nature → Research Square), the paper uses that publisher's server for streamlined transfer. This reduces the unique preprint server count from 20 to 12.
...
_Hameem M Mahdi, B.S.C.S., M.S.E., Ph.D. — AI Systems Landscape 2026_
