%%
%% #0-unified-taxonomy.tex — aiXiv Preprint Format
%% Paper #0 in the AI Systems Landscape 2026 series
%% License: CC BY 4.0
%%
...
\lhead{\textsc{aiXiv Preprint} — CC BY 4.0}
\rhead{\thepage}
\lfoot{\footnotesize AI Systems Landscape 2026 — Paper \#0}
...
%% ================================================================
\begin{center}
    {\Large\bfseries A Unified Taxonomy of 19 AI System Types:\\[4pt]
    Architecture, Capability, and Deployment Analysis\\[2pt]
    ...
    {\small Paper \#0 in the \emph{AI Systems Landscape 2026} series}
\end{center}
...
%%
%% Keywords (placed after abstract)
\noindent\textbf{Keywords:} AI Taxonomy, System Architecture, Capability Analysis, Deployment Framework, Artificial Intelligence Classification, Machine Learning Systems, Neuro-Symbolic AI, Agentic Systems
\vspace{0.5em}
...
\begin{table}[ht]
  ...
  \begin{tabular}{c p{3.5cm} p{4cm} p{5.5cm}}
    ...
    4 & Reinforcement Learning & Trial-and-error optimization & Learns through environmental reward feedback \\
    ...
    11 & Evolutionary / Genetic & Population-based optimization & Evolves solutions through selection and variation \\
    12 & Optimization / Ops Research & Constraint satisfaction & Finds optimal or near-optimal solutions \\
...
\textbf{Capabilities.} Key capabilities include sequential decision-making with long-horizon optimization, autonomous skill acquisition through trial-and-error, adaptation to new environments, strategic planning through learned models, and multi-agent coordination in competitive or cooperative settings.
...
\subsubsection{System 12: Optimization / Operations Research AI Systems}
\textbf{Definition.} AI systems based on mathematical optimization techniques for resource allocation, planning, and operational problem-solving, providing provably optimal or near-optimal solutions with formal guarantees.

\textbf{Architecture.} These feature linear and integer programming solvers (CPLEX, Gurobi), constraint programming and satisfaction engines, mixed-integer programming, dynamic programming, metaheuristics (simulated annealing, tabu search), and increasingly, learning-augmented optimization layers.

\textbf{Capabilities.} Key capabilities include provably near-optimal solutions with quality bounds, complex constraint satisfaction, large-scale problem solving, real-time re-optimization for dynamic conditions, sensitivity analysis, and robust optimization under uncertainty.
...
\begin{table}[ht]
  ...
  \begin{tabular}{lcccc}
    ...
    Optimization / OR & Low & High & Low & Medium \\
...
\textbf{Reasoning Depth.} Deep reasoning characterizes Cognitive/Neuro-Symbolic, Symbolic/Rule-Based, and Bayesian/Probabilistic systems. Moderate reasoning is found in Analytical, Scientific/Simulation, and Optimization/OR systems. Limited explicit reasoning characterizes Reactive, Predictive/Discriminative, and purely Generative systems.
...
% C3: Learning & Optimization (4 systems)
\addplot[scatter, only marks, scatter src=explicit symbolic]
  coordinates { (0.7,2.2)[c3] (1.7,1.0)[c3] (2.5,3.0)[c3] (3.7,1.1)[c3] };
\addlegendentry{Learning \& Optimization}
...
\node[font=\tiny, anchor=north] at (axis cs:3.7,0.93) {Optimization / OR};
% C4 labels
...
\begin{tikzpicture}[
  ...
  \node[rbox, fill=green!8] (boxC) at (5.8,-7.0)
    {\textbf{Learning \& Optimization:}\\[1pt]
     ...
     \textbullet~Constraint solving $\rightarrow$ \textbf{Optimization/OR}\\
...
All datasets, analysis scripts, and supplementary materials are publicly available at \url{https://github.com/HAMEEMM/ai_systems_landscape_2026/tree/main/publications/00-unified-taxonomy/data}.
